Feature: Schedule
  ...
  Scenario: show for user
    ...
    Then I should see calendar
     ...
     And I should see "yoga" in cell (Monday, 11:30)
     And I should see "yoga" in cell (Sunday, 17:30)
     And I should see "close dance" in cell (Monday, 11:30)
     And I should see "close dance" in cell (Thursday, 20:30)
  ...
  Scenario: show lessons for specific style
    ...
    When I go to "/lessons"
     And I click to "yoga"
    Then I should see "yoga" in cell (Monday, 11:30)
     And I should see "yoga" in cell (Sunday, 17:30)
     But I shouldn't see "close dance" in cell (Monday, 11:30)
     And I shouldn't see "close dance" in cell (Thursday, 20:30)
  ...
  Scenario: Click to day
    ...
    Then I should see that column "Monday" is fatter than other
     And I should see "yoga" in cell (Tuesday, 11:30)
     And I should see "yoga" in cell (Sunday, 17:30)
     But I shouldn't see "close dance" in cell (Monday, 11:30)
     And I shouldn't see "close dance" in cell (Thursday, 20:30)
